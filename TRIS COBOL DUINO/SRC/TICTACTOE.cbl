      ...
      ******************************************************************
      *         IMPROVEMENTS:
      *            I1. IMPLEMENTED REMOTE CONTROLLED SERIAL COMMS.
      ******************************************************************
      *
      *         BUG FIXES:
...
I1     77 SOCKET-HANDLE  USAGE HANDLE.
I1    *   Arguments decoded by ARDUINO
I1     77 CMD-ARGS       PIC X(1)       VALUE SPACES.
      ...
      * PROPERTIES & USER DEFINED WORKING STOARGE
       ...
       77 COMPUTER-CHOSE    PIC   9(1)        VALUE ZERO.
...
I1         PERFORM INIT-TCP-CONNECTION
      ...
      /
I1    * --------------------------------------------------------------
I1    *   INITIALIZE TCP CONNECTIONS
I1    * --------------------------------------------------------------
I1     INIT-TCP-CONNECTION.
I1          CALL 'C$SOCKET'         USING 3
I1                                        64000
I1                                        "127.0.0.1"
I1                                  GIVING SOCKET-HANDLE
I1          .
      /
      * --------------------------------------------------------------
      ...
      *       ACCEPT FORM1
      *          ON EXCEPTION
I1                  CALL 'C$SLEEP' USING 0.1      
I1                  PERFORM RECEIVE-TCP-DATA      
      ...
      *       END-ACCEPT
      ...
      /
I1    * --------------------------------------------------------------
I1    *   RECEIVE THE DATA FROM THE TCP DRIVER
I1    * --------------------------------------------------------------
I1     RECEIVE-TCP-DATA.
I1            CALL 'C$SOCKET'      USING 6
I1                                 SOCKET-HANDLE
I1                                 CMD-ARGS
I1                                 1
I1
I1            EVALUATE CMD-ARGS
I1               WHEN 'A' MOVE 1001 TO KEY-STATUS
I1               WHEN 'B' MOVE 1002 TO KEY-STATUS
I1               WHEN 'C' MOVE 1003 TO KEY-STATUS
I1               WHEN 'D' MOVE 2001 TO KEY-STATUS
I1               WHEN 'E' MOVE 2002 TO KEY-STATUS
I1               WHEN 'F' MOVE 2003 TO KEY-STATUS
I1               WHEN 'G' MOVE 3001 TO KEY-STATUS
I1               WHEN 'H' MOVE 3002 TO KEY-STATUS
I1               WHEN 'I' MOVE 3003 TO KEY-STATUS
I1               WHEN 'R' MOVE 5001 TO KEY-STATUS
I1            END-EVALUATE
I1         .
      /
      * --------------------------------------------------------------
...
FIX.4         PERFORM CHECK-GRID-FULL
      ...
      * ..... FINAL STAGE: LAST MOMENTS AFTER LONG FIGHTING :)
      ...
      /
I1    * --------------------------------------------------------------
I1    *   SENDING MESSAGE BACK TO THE TCP DRIVER FOR ARDUINO
I1    * --------------------------------------------------------------
I1     SEND-TCP-MESSAGE.
I1          MOVE COMPUTER-CHOSE  TO CMD-ARGS
I1    *
I1          CALL 'C$SOCKET'   USING 5
I1                                  SOCKET-HANDLE
I1                                  CMD-ARGS
I1                                  1
I1    *
I1    **     CALL 'C$SOCKET'   USING 8, SOCKET-HANDLE, 10
I1          MOVE ZERO TO KEY-STATUS
I1         .
      /
      * --------------------------------------------------------------
