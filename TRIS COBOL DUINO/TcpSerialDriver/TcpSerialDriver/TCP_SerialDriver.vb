...
#End Region
    ...
    Private Sub SerialPort_DataReceived(sender As Object, e As SerialDataReceivedEventArgs) Handles serialPort.DataReceived
        inSerialData = serialPort.ReadExisting().Replace(vbCrLf, "").Replace(vbLf, "").Trim()
        Console.WriteLine("Incoming SERIAL Data: " & inSerialData)
    ...
    Private Sub ClientExited(ByVal client As TCP_Server)
